...
import OverlayExperiment from "./OverlayExperiment";

// Section imports
import ImpactMetrics from "./sections/ImpactMetrics";
import FeaturedProjectsSliderExperiment from "./sections/FeaturedProjectsSliderExperiment";
...
export default function HomeClientExperiment() {
  ...
  // Fade in content sections as they scroll into view
    ...
    <main className="bg-[#080810] text-[#fafafa]" style={{ overflowX: "clip" }}>
      ...
      >
        ...
        <section ref={heroRef} className="relative">
          ...
          <OverlayExperiment progress={heroProgress} />
        </section>
        ...
        >
          {/* Content sections */}
          <ImpactMetrics />
          <FeaturedProjectsSliderExperiment />
          {/* <FeaturedProjects /> */}
          <DesignProcess />
          <About />
          <Skills />
